          ...
          <div>
            ...
            <div className="pt-6">
              <p className="dark:text-slate-200 text-gray-700 leading-relaxed text-base">
                Wholesale Trading Supplies is a leading provider of mobile and
                electronic accessories products to wholesalers and retailers in
                the UK and Europe.
              </p>

              <p className="mt-4 dark:text-slate-300 text-gray-600 leading-relaxed text-base">
                From our purpose built, Watford based warehousing unit, we are
                able to provide a large range of instantly available, bulk order
                products for next day delivery at competitive prices.
              </p>
